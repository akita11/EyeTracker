...
set_property -dict [list CONFIG.dividend_and_quotient_width {28} CONFIG.divisor_width {20} \
             CONFIG.operand_sign {Unsigned} CONFIG.ACLKEN {true} CONFIG.ARESETN {true} \
             CONFIG.fractional_width {20} CONFIG.FlowControl {Blocking} \
             CONFIG.OutTready {true} CONFIG.latency {33}] [get_ips DIV_28_20]
